  ...
  Widget build(BuildContext context) {
    return  MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) =>  GetUserCityWeatherControllerBloc(sLocator())..add(const GetUserCityWeather())),
        BlocProvider(create: (context) =>  GetSavedCitiesControllerBloc(sLocator())),
      ],
      child:  MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
