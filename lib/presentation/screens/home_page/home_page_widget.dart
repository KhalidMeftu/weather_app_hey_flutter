...
class _WeatherAppHomePageState extends State<WeatherAppHomePage>
                    ...
                    return BlocConsumer<HomeControllerBloc,
                      ...
                      builder: (context, state) {
                        if (state is CurrentCityDataLoaded) {
                          ...
                          return currentCityLoadedUI(
                              weatherCityModel, upcomingDays);
                        }
                      ...
                      listener:
                        ...
                        if (state is CurrentCityWeatherInfoLoadingError) {
                          AppUtils.showToastMessage(
                              WeatherAppString.noCityData, Toast.LENGTH_LONG);
  ...
  Stack currentCityLoadedUI(
      WeatherModel weatherCityModel, List<String> upcomingDays) {
    return Stack(
      children: [
