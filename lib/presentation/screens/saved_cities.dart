                      ...
                      if (state is UserCityLoaded) {
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            print("Saved cities loaded");
                            print(state.usermodel[index].isCurrentCity);
                            return Padding(
                              padding: EdgeInsets.only(
                              ...
                              child: GestureDetector(
                                ...
                                child: SavedCitiesCard(
                                  ...
                                  weatherCondition: state
                                      .usermodel[index].weather[0].description,
                                ...
                                child: GestureDetector(
                                  ...
                                  child: SavedCitiesCard(
                                    ...
                                    humidity: state.weatherModel[index].main.humidity
                                        .toString(),
                                    windSpeed: state.weatherModel[index].wind.speed
                                        .toString(),
                                    statusImage:
                                    state.weatherModel[index].weather[0].icon,
                                    temprature: state.weatherModel[index].main.temp
                                        .toString(),
                                    isHomeCity:
                      ...
                      if(liState is CityWeatherLoaded)
                        {
                          ...
                          newModel.cityImageURL = liState.usermodel.cityImageURL;
